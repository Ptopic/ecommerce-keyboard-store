	...
	return (
		<div className="featured-section">
			...
			<div className="featured-container">
				<Link
					to="/products?new=new&name=New+Arrivals"
					className="featured-card"
				>
					<img
						src="https://dangkeebs.com/cdn/shop/collections/Strawberry-Milk-Switches-Instagram-Rez.jpg?v=1680222683&width=330"
						alt=""
					/>
					<div>
				...
				<Link
					to="/products/best?name=Best+Sellers" className="featured-card">
					<img
				...
				<Link
					to="/products/keyboard?name=Keyboards" className="featured-card">
					<img
